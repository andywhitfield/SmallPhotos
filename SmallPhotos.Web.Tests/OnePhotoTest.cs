...
public class OnePhotoTest
{
    ...
    public async Task InitializeAsync()
    {
        ...
        context.Photos!.Add(new() { AlbumSource = album.Entity, CreatedDateTime = DateTime.UtcNow, FileCreationDateTime = DateTime.UtcNow, Filename = "photo1.jpg", Height = 10, Width = 15 });
